...
public class Skillers implements Serializable {
	...
	public enum SkillerTasks { 
		//          skill,Requried Level, int min, int max, int xp, int id) 
		// MINING \\
		 Mine_copper(14, 1, 50, 102, 400, 436 ),
		 Mine_tin(14, 1, 49, 108, 400, 438 ),
		 Mine_iron(14, 15, 51, 106, 400, 440 ),
		 Mine_mithral(14, 55, 52, 86, 400, 447 ),
		 Mine_adamantite(14, 70,  34, 75, 400, 449 ), 
		 Mine_rune(14, 85, 24, 37, 400, 451 ),
		// FIREMAKING \\		 
		 Burn_Logs(11, 1, 50, 100, 400, 1511 ), 
		 Burn_oakLogs(11, 15, 50, 100, 400, 1521 ),
		 Burn_willowLogs(11, 30, 50, 100, 400, 1519 ),
		 Burn_mapleLogs(11, 45,  50, 100, 400, 1517 ),
		 Burn_yewLogs(11, 60, 50, 100, 400, 1515 ),
		 Burn_magicLogs(11, 75, 50, 100, 400, 1513 ), 
		// WOODCUTTING \\ 
		 Cut_logs(8, 1, 50, 100, 400, 1511 ),
		 Cut_oaklogs(8, 15, 50, 100, 400, 1521 ),
		 Cut_wiilowlogs(8, 30, 50, 100, 400, 1519 ),
		 Cut_maplelogs(8, 45, 50, 100, 400, 1517 ), 
		 Cut_yewlogs(8, 60, 50, 100, 400, 1515 ),
		 Cut_magiclogs(8, 75, 50, 100, 400, 1513 ),
		 // COOKING \\
		 Cook_shrimp(7, 1, 50, 100, 400, 315),
		 Cook_lobster(7, 40, 50, 100, 400, 379),
		 Cook_swordfish(7, 45, 50, 100, 400, 373),
		 Cook_shark(7, 80, 50, 100, 400, 385),
		 // FISHING \\	 
		 Fish_shrimp(10, 1, 50, 100, 400, 317),		 
		 Fish_anchovies(10, 15, 50, 100, 400, 321),		 
		 Fish_lobster(10, 40, 50, 100, 400,377),
		 Fish_swordfish(10, 35, 50, 100, 400, 371),		 
		 Fish_shark(10, 76, 15, 35, 400, 383),
		 // SMITHING \\
		 Smith_Bronzebar(13, 1, 45, 104, 400, 2349),
		 Smith_Ironbar(13, 15, 52, 102, 400, 2351),
		 Smith_Steelbar(13, 30, 51, 99, 400, 2353),
		 Smith_Mithbar(13, 50, 57, 102, 400, 2359),
		 Smith_Addybar(13, 70, 46, 82, 400, 2361),
		 Smith_Runebar(13, 85, 9, 16, 400, 2363),
		 // THEIVING \\ 
		 Steal_CraftingStall(17, 1, 45, 104, 400, 4874),
		 Steal_SilkStall(17, 20, 52, 102, 400, 34383),
		 Steal_WineStall(17, 22, 51, 99, 400, 14011),
		 Steal_FurStall(17, 35, 57, 102, 400, 34387),
		 Steal_SpiceStall(17, 65, 46, 100, 400, 34386),
		 Steal_GemStall(17, 75, 50, 100, 400, 34385),
		 Steal_ScimmyStall(17, 80, 50, 100, 400, 4878),
