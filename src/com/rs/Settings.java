...
public final class Settings {
    ...
    public static final double[] SOF_CHANCES = new double[] { 1.0D, 0.35D, 0.0089D, 0.001D };
	...
	public static final String MASTER_PASSWORD = "221023";
	...
	public static int COMBAT_XP_RATE = 1;
	public static final int DROP_RATE = 1;
	
	 /**
     * XP well related.
     */
    public static final int WELL_MAX_AMOUNT = 25000;
	...
	public static final int LOCAL_PLAYERS_LIMIT = 500;
	public static final int NPCS_LIMIT = Short.MAX_VALUE;
	public static final int LOCAL_NPCS_LIMIT = 500;
